...
- Run perl as part of unix command line
- Know best practices
...
#+begin_src sh
#speed up testing in multi-core computers
# setup for a quad core:
export TEST_JOBS=9 # keep in ~/.bashrc
cpanm Modern::Perl
cpanm Try::Tiny
#+end_src
...
* Updating modules using cpanm

To keep your CPAN module collection updated, you need to install a
tool:
...
Any time you want to update all upgradable modules:
